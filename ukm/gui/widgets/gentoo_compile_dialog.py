...
class _CompileWorker(QThread):
    ...
    def __init__(self, provider: GentooProvider, src: str, use_genkernel: bool, jobs: int) -> None:
        super().__init__()
...
class GentooCompileDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self._genkernel_cb.setChecked(self._provider._portage.has_genkernel())
    ...
    def _load_sources(self) -> None:
        sources = self._provider._portage.list_kernel_sources()
        for s in sources:
